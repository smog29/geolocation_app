  ...
  class UpdateGeolocationService < GeolocationService
    ...
    def call
      ...
      if geolocation.blank?
        return Results::GeolocationResult.new(success: false, errors: "Geolocation not found")
      end
    ...
    def update_geolocation(geolocation, geolocation_data)
      if geolocation_data.present? && geolocation_data["ip"].present?
        ...
        Results::GeolocationResult.new(success: false, errors: "Geolocation data could not be retrieved")
      end
    end
  end
end
